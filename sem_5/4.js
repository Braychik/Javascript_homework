...
const productsHavePhoto = products.filter(product => product.photos && product.photos.length > 0);
console.log(productsHavePhoto);

const sortProduct = products.sort((x, y) => x.price - y.price);
